<template>
  <div>
    <head>
      <link href="https://fonts.googleapis.com/css2?family=Caveat:wght@400..700&family=Charm:wght@400;700&family=Homemade+Apple&family=Mansalva&family=Playwrite+AU+SA:wght@100..400&family=Rouge+Script&family=Sue+Ellen+Francisco&display=swap" rel="stylesheet">
    </head>
    <VideoPopup />
