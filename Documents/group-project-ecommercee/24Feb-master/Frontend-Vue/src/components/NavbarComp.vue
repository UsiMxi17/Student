...
.holo-banner {
  ...
  letter-spacing: 1px;
  position: relative; /* Add position for smoother animation */
}
...
.promo-text {
  ...
  animation: marquee 12s linear infinite; /* Keep the marquee smooth and continuous */
...
/* Navbar Styling */
.navbar {
  font-family: "Poppins", sans-serif; /* Using the new pretty font */
  font-weight: 300; /* Semi-light font weight */
}
...
.nav-link {
  ...
  letter-spacing: 1px;
  text-transform: uppercase;
  font-weight: 300; /* Semi-light weight for the nav links */
...
.navbar-brand.glitter {
  font-size: 24px;
  font-weight: 400; /* Slightly bolder for the brand */
  letter-spacing: 1px;
  color: #ff758c;
  ...
  margin-left: 20px; /* Add this line to move it to the right */
}
...
.dropdown-item {
  font-weight: 300; /* Semi-light font weight for dropdown items */
  color: #333;
}

.dropdown-item:hover {
  background-color: #ff758c; /* Hover effect */
  color: white;
}
